...
<body>
	...
	<div class=cate_logo align="center">
		<img src="<%=src%>" width="auto" height="70px" style="margin-top:20px">
	</div>
		...
		<div class="All_Prod">
			<div class="big" align="center">
				...
				<div class="price font-small">
					현재가:<%=list.get(i).getProd_cur()%>원 <br> 즉시구매가:<%=list.get(i).getProd_imme()%>원
				</div>
