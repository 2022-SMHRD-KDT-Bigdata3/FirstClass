	...
	<div class="wrap">
		...
		<div class="main_text0">
			<div class="icons">
				<div class="all_prod">
					<div class="box">
						<li><a href="AllProd.jsp"><img
								style="width: 85.5%; vertical-align: center;"
								src="image/allProd_logo.png" class="logo"></a></li>
					</div>
					<div class="box" align="left">
						<li><a href="CateProd.jsp?cate_num=12"><img
								style="width: 85%; vertical-align: center;"
								src="image/marvel_logo.png" class="logo"></a></li>
					</div>
					<div class="box">
						<li><a href="CateProd.jsp?cate_num=4"><img
								style="width: 85.5%; vertical-align: center;" src="image/disney_logo.png"
								class="logo"></a></li>
					</div>
					<div class="box">
						<li><a href="CateProd.jsp?cate_num=6"><img
								style="width: 83%; vertical-align: center;" src="image/demon_slayer_logo.png"
								class="logo"></a></li>
					</div>
					<div class="box">
						<li><a href="CateProd.jsp?cate_num=8"><img
								style="width: 83%; vertical-align: center;" src="image/bandai_logo.png" class="logo"></a></li>
					</div>
					<div class="box">
						<li><a href="CateProd.jsp?cate_num=10"> <img
								style="width: 83%; vertical-align: center;" src="image/onepice_logo.png" class="logo"></a></li>
					</div>
					<div class="box">
						<li><a href="CateProd.jsp?cate_num=2"><img
								style="width: 85.5%; vertical-align: center;" src="image/etc_logo.png" class="logo"></a></li>
					</div>
				</div>
			</div>
			<div class="prod_text">
				<a href="AllProd.jsp">
					...
					<li>원피스</li>
				</a> <a href="CateProd.jsp?cate_num=2">
					<li>기타</li>
				</a>
			</div>
		</div>
		<div class="sub_text0" style="width: 100%; height: 100px;"></div>
	</div>
</body>
