   ...
   <div class="wrap">
      ...
      <div class="main_bg">
         ...
         <div class="main_menu">
            ...
            <div class="prm_main_content" align="center">
               <div class="prm_element">
                  <form action="ProdRegi_MemberService" method="post">
                     ...
                     <table class="prm_table" border="1">
                        ...
                        <tr>
                           ...
                           <td><input id="prm_isUrg_Y" type="radio" name="isUrg"
                              value="Y">예 <input id="prm_isUrg_N" type="radio"
                              name="isUrg" value="N">아니오</td>
                        </tr>
                        <tr>
                           <td class="prm_btn" colspan="2"><input type="reset"
                              value="초기화"> <input type="submit" value="등록">
                           </td>
                        </tr>
                     </table>
                  </form>
