<%@page import="com.smhrd.model.Join2DAO"%>
<%@page import="com.smhrd.model.Join2VO"%>
...
<body>
	<%
	ArrayList<Join2VO> list = new ArrayList<>();
	Join2DAO dao = new Join2DAO();
	
	list = dao.selectPopProd();
	...
	<table border="1">
		...
		<tr>
			<td style="inline-height: 0"><img
				src="<%=list.get(i).getProd_img()%>" width="200px" height="200px"
